    ...
    public class WxPayApi
    {
        ...
        */
        public static WxPayData Micropay(WxPayData inputObj, int timeOut = 10)
        {
            ...
            ClassLoger.DEBUG("WxPayApi", "MicroPay request : " + xml);
            string response = HttpService.Post(xml, url, false, timeOut);//调用HTTP通信接口以提交数据到API
            ClassLoger.DEBUG("WxPayApi", "MicroPay response : " + response);
	    ...
	    */
        public static WxPayData RefundQuery(WxPayData inputObj, int timeOut = 6)
        {
            ...
            ClassLoger.DEBUG("WxPayApi", "RefundQuery request : " + xml);
            string response = HttpService.Post(xml, url, false, timeOut);//调用HTTP通信接口以提交数据到API
            ClassLoger.DEBUG("WxPayApi", "RefundQuery response : " + response);
        ...
        */
        public static WxPayData DownloadBill(WxPayData inputObj, int timeOut = 6)
        {
            ...
            ClassLoger.DEBUG("WxPayApi", "DownloadBill request : " + xml);
            string response = HttpService.Post(xml, url, false, timeOut);//调用HTTP通信接口以提交数据到API
            ClassLoger.DEBUG("WxPayApi", "DownloadBill result : " + response);
        ...
        */
        public static WxPayData UnifiedOrder(WxPayData inputObj, int timeOut = 6)
        {
            ...
            ClassLoger.DEBUG("WxPayApi", "UnfiedOrder request : " + xml);
            string response = HttpService.Post(xml, url, false, timeOut);
            ClassLoger.DEBUG("WxPayApi", "UnfiedOrder response : " + response);
	    ...
	    */
        public static WxPayData Report(WxPayData inputObj, int timeOut = 1)
        {
            ...
            ClassLoger.Info("WxPayApi", "Report request : " + xml);

            string response = HttpService.Post(xml, url, false, timeOut);

            ClassLoger.Info("WxPayApi", "Report response : " + response);
        ...
        */
        ...
        {
            var ran = new Random();
            return string.Format("{0}{1}{2}", SystemSet.Mch_id, DateTime.Now.ToString("yyyyMMddHHmmss"), ran.Next(999));
        }
        ...
        */
        ...
        /// </summary>
        /// <returns></returns>
        public static WxPayData transfers(WxPayData inputObj, int timeOut = 6)
        {
            string url = "https://api.mch.weixin.qq.com/mmpaymkttransfers/promotion/transfers";
            inputObj.SetValue("mch_appid", SystemSet.Serviceappid);//公众账号ID
            inputObj.SetValue("mchid", SystemSet.Mch_id);//商户号
            inputObj.SetValue("nonce_str", GenerateNonceStr());//随机字符串		
            inputObj.SetValue("sign", inputObj.MakeSign());//签名
            string xml = inputObj.ToXml();
