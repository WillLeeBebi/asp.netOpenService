...
namespace liemei.Common.cache
{
    public class MemcachedHelper
    {
        ...
        private static string[] servers = System.Configuration.ConfigurationSettings.AppSettings["MemachedServers"].Split(new char[] { ';' });
        ...
        private static MemcachedHelper _Ins;
        public static MemcachedHelper Ins
        {
            get
            {
                if (_Ins == null)
                    _Ins = new MemcachedHelper();
                return _Ins;
            }
        }
        ...
        //public bool AddCache(string key,object value, outtime)
        //{
        //    return cache.Add(key,value,);
        //}
    }
