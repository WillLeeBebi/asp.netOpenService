...
public class CrawlerHandler : Handler
{
    ...
    public CrawlerHandler(HttpContext context,string ImageServicePath) : base(context) { this.ImageServicePath = ImageServicePath; }
    ...
    public override void Process()
    {
        ...
        Crawlers = Sources.Select(x => new Crawler(x, Server).Fetch(ImageServicePath)).ToArray();
        WriteJson(new
        {
            state = "SUCCESS",
...
public class Crawler
{
    ...
    public Crawler Fetch(string ImageServicePath)
    {
        ...
        using (var response = request.GetResponse() as HttpWebResponse)
        {
            ...
            {
                savePath = Path.Combine(ImageServicePath, ServerUrl);
            }
