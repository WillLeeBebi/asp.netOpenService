...
function WeChartBuyPtest(psid, userid, useropenid) {
    ...
    var wecharPsychtestConfig = {
        ...
        WeiXinJsapiConfig: function () {
            ...
            var link = 'http://open.bnuxq.com/Psychtest/PsychTestInfo?id=' + this.pid + "&userid=" + this.louserid
            $.get("/WeixinRedirect/jssignature?url=" + url, function (data) {
                ...
                wx.ready(function () {
                    ...
                    wx.onMenuShareTimeline({
                        ...
                        success: function () {
                            // 用户确认分享后执行的回调函数
                            $.get("/Psychtest/PsychTestShare?id=" + this.pid + "&userid=" + this.userid);
                        },
                        cancel: function () {
                            // 用户取消分享后执行的回调函数
                        }
                    ...
                    wx.onMenuShareAppMessage({
                        ...
                        success: function () {
                            ...
                            $.get("/Psychtest/PsychTestShare?id=" + this.pid + "&userid=" + this.userid, function (msg) {
                            });
                        },
                        cancel: function () {
                            // 用户取消分享后执行的回调函数
